...
## 2.0.0
  ...
  - added requirejs AMD support for `dist/parsley.js` and `dist/parsley.js`
    versions (#606)
...
## 2.0.0-rc5
  ...
  - `dist/parsley+remote.js` and `dist/parsley+remote.js` have been renamed
    to `dist/parsley.remote.js` and `dist/parsley.remote.js`
