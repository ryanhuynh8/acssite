	...
	grunt.initConfig({
		...
		uglify: {
			dist: {
				...
				files: {
					'dist/<%= cfg.filename %>.js': ['dist/<%= cfg.filename %>.js'],
					'dist/jquery.<%= cfg.filename %>.js': ['dist/jquery.<%= cfg.filename %>.js'],
					'dist/angular.<%= cfg.filename %>.js': ['dist/angular.<%= cfg.filename %>.js']
				}
			}
		},
