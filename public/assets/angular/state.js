    ...
    .config(['$stateProvider', '$urlRouterProvider',
        function ($stateProvider, $urlRouterProvider) {
            ...
            $stateProvider
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    // easePie chart
                                    'assets/lib/easy-pie-chart/dist/jquery.easypiechart.js',
                                    // dashboard functions
                                    'assets/angular/states_jquery/yukon_dashboard.js'
                                ]);
                            }
                        ]
                    },
                ...
                .state('auth.tasks', {
                    page_title: "ACS Absolute Comfort - Task List",
                    url: '/tasks',
                    data: {
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/ion.rangeSlider/js/ion-rangeSlider/ion.rangeSlider.js',
                                    // autosize
                                    'assets/lib/autosize/jquery.autosize.js',
                                    // inputmask
                                    'assets/lib/jquery.inputmask/jquery.inputmask.bundle.js',
                                    // maxlength for textareas
                                    'assets/lib/stopVerbosity/stopVerbosity.js',
                                    // uplaoder
                                    'assets/lib/plupload/js/jquery.plupload.queue/css/jquery.plupload.queue.css',
                                    'assets/lib/plupload/js/plupload.full.js',
                                    'assets/lib/plupload/js/jquery.plupload.queue/jquery.plupload.queue.js',
                                    // wysiwg editor
                                    ...
                                    // quicksearch
                                    'assets/lib/quicksearch/jquery.quicksearch.js',
                                    // clock picker
                                    'assets/lib/clock-picker/bootstrap-clockpicker.js',
                                    // chained selects
                                    'assets/lib/jquery_chained/jquery.chained.js',
                                    // show/hide passwords
                                    'assets/lib/hideShowPassword/hideShowPassword.js',
                                    // password strength meter
                                    'assets/lib/jquery.pwstrength.bootstrap/pwstrength-bootstrap-1.2.2.js',
                                    // icheck
                                    'assets/lib/iCheck/skins/minimal/blue.css',
                                    'assets/lib/iCheck/icheck.js',
                                    // selectize.js
                                    'assets/lib/selectize-js/css/selectize.css',
                                    'assets/lib/selectize-js/js/standalone/selectize.js',
                                    // forms extended elements
                                    'assets/angular/states_jquery/yukon_extended_elements.js'
                                ]);
                            }
                        ]
                    },
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/gridforms/gf-forms.js'
                                ])
                            }
                        ]
                    }
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/parsley/dist/parsley.js',
                                    // select2
                                    'assets/lib/select2/select2.css',
                                    'assets/lib/select2/select2.js',
                                    // wysiwg editor
                                    ...
                                    'assets/angular/states_jquery/yukon_validation.js'
                                ])
                            }
                        ]
                    },
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/select2/select2.js',
                                    // jquery steps
                                    'assets/js/jquery.steps.custom.js',
                                    // validation
                                    'assets/js/parsley.config.js',
                                    'assets/lib/parsley/dist/parsley.js',
                                    // form wizard functions
                                    'assets/angular/states_jquery/yukon_wizard.js'
                                ])
                            }
                        ]
                    },
                    ...
                    resolve: {
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    //  chat functions
                                    'assets/angular/states_jquery/yukon_chat.js'
                                ])
                            }
                        ]
                    },
                    ...
                    resolve: {
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    // shuffle.js
                                    'assets/lib/shuffle/jquery.shuffle.modernizr.js'
                                ])
                            }
                        ]
                    },
                    ...
                    resolve: {
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    //  qrCode
                                    'assets/lib/jquery-qrcode-0.10.1/jquery.qrcode-0.10.1.js'
                                ])
                            }
                        ]
                    },
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/footable/footable.js',
                                    'assets/lib/footable/footable.paginate.js',
                                    'assets/lib/footable/footable.filter.js'
                                ])
                            }
                        ]
                    },
                    ...
                    resolve: {
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    //  iOS list
                                    'assets/lib/jquery-listnav/dist/js/jquery-listnav-2.4.0.js'
                                ])
                            }
                        ]
                    },
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/easy-pie-chart/dist/jquery.easypiechart.js',
                                    // dashboard functions
                                    'assets/angular/states_jquery/yukon_user_profile.js'
                                ]);
                            }
                        ]
                    },
                        ...
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    ...
                                    'assets/lib/jBox-0.3.0/Source/jBox.js'
                                ]);
                            }
                        ]
                    },
                    ...
                    resolve: {
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    // full calendar
                                    'assets/lib/fullcalendar/lib/jquery-ui.custom.js',
                    ...
                    resolve: {
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    // gantt chart
                                    'assets/lib/jquery.ganttView/jquery-ui.js',
                    ...
                    resolve: {
                        files: [
                            ...
                            function (uiLoad) {
                                return uiLoad.load([
                                    //  datatables
                                    'assets/lib/DataTables/media/js/jquery.dataTables.js',
                                    'assets/lib/DataTables/extensions/FixedHeader/js/dataTables.fixedHeader.js',
