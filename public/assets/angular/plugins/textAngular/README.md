...
Include script tags similar to the following:
```html
	<script src='http://cdnjs.cloudflare.com/ajax/libs/textAngular/1.2.2/textAngular-sanitize.js'></script>
<script src='http://cdnjs.cloudflare.com/ajax/libs/textAngular/1.2.2/textAngular.js'></script>
```
...
```html
<script src='http://cdn.jsdelivr.net/g/angular.textangular@1.2.2(textAngular-sanitize.js+textAngular.js)'></script>
```
...
1. Include `textAngular-sanitize.js` or `textAngular-sanitize.js` in your project using script tags
2. Include `textAngularSetup.js` and `textAngular.js` or `textAngular.js` (textAngularSetup.js is included inside textAngular.js)
